...
<head>
    ...
    <r:require modules="leaflet, search, slider, qtip, nanoscroller, amplify, moment, mapCommon, bootstrapSwitch"/>
...
<body class="occurrence-search">
    ...
    <g:else>
        ...
        <div class="row-fluid" id="content">
            <div class="span3">
                <g:render template="/occurrence/facets" plugin="biocache-hubs"/>
            </div>
